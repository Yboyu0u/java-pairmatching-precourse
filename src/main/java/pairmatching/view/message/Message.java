...
public class Message {
	...
	public static final String PRINT_MATCHING_INFORMATION = "#############################################\n"
		+ "과정: 백엔드 | 프론트엔드\n"
		+ "미션:\n"
		+ "  - 레벨1: 자동차경주 | 로또 | 숫자야구게임\n"
		+ "  - 레벨2: 장바구니 | 결제 | 지하철노선도\n"
	...
	public static final String SELECT_MATCHING_INFORMATION = "과정, 레벨, 미션을 선택하세요.\n"
		+ "ex) 백엔드, 레벨1, 자동차경주";
	...
	public static final String PRINT_INITIALIZED = "초기화 되었습니다. ";
}
